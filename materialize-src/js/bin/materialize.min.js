  ...
  (function(d) {
    (M.updateTextFields = function() {
      ...
      d(document).ready(function() {
        var n =
          'input[type=front], input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], input[type=date], input[type=time], textarea';
            ...
            [
              {
                key: 'init',
                value: function(t, e) {
                  return _get(B.__proto__ || Object.getPrototypeOf(B), 'init', this).call(
                    this,
                    this,
                    t,
                    e
              ...
              },
              {
                key: '_getDaysInMonth',
                value: function(t, e) {
                  return [31, B._isLeapYear(t) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][
                    e
                  ];
                }
              },
                    ...
                    for (var e = 1; e < 13; e += 1) {
                      ...
                      i.css({
                        left:
                          ...
                          'px',
                        top:
                          this.options.dialRadius - Math.cos(n) * s - this.options.tickRadius + 'px'
                      }),
                        i.html(0 === e ? '00' : e),
                    ...
                    for (var o = 0; o < 24; o += 1) {
                      ...
                      a.css({
                        left:
                          ...
                          'px',
                        top:
                          this.options.dialRadius - Math.cos(r) * l - this.options.tickRadius + 'px'
                      }),
                        a.html(0 === o ? '00' : o),
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  for (a = 1; a <= i; ++a) {
                    if (
                      (this.options.fullWidth
                        ? ((h = this.options.dist), (d = a === i && n < 0 ? 1 - o : 1))
                    ...
                    if (
                      (this.options.fullWidth
                        ? ((h = this.options.dist), (d = a === i && 0 < n ? 1 - o : 1))
                        : ((h = this.options.dist * (2 * a - o * s)),
                          (d = 1 - p * (2 * a - o * s))),
